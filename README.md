...
> Чтобы получить кол для вставки вам нужно зарегистрироваться в системе и потом добавить свой сайт и выбрать нужный вам виджет. 

В целом скрипт, самая простав версия скрипта со всеми стандартными настройками выглядит следующим образом.
